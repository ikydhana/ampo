<?php namespace App\Http\Controllers;
	...
	class AdminKegiatanController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "id";
			$this->limit = "20";
			$this->orderby = "tgl_kegiatan,desc";
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Tgl Kegiatan","name"=>"tgl_kegiatan","type"=>"date","required"=>TRUE,"validation"=>"required|date"];
			...
			//$this->form[] = ["label"=>"Foto Keg","name"=>"foto_keg","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM
