<?php namespace App\Http\Controllers;
	...
	class AdminSiswaController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Photo','name'=>'photo','type'=>'upload','validation'=>'image','width'=>'col-sm-10','help'=>'Tipe file yang didukung: JPG, JPEG, PNG, GIF, BMP'];
			...
			//$this->form[] = ['label'=>'Notlp','name'=>'notlp','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
